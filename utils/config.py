...
_C.DATASET.CONT_ROOT = "./datasets/ImageNet/ILSVRC2012_img_val"  # "./datasets/CelebAMask-HQ"  # "./datasets/ImageNet/ILSVRC2012_img_val"
_C.DATASET.IMAGENET = "./datasets/ImageNet/ILSVRC2012_img_val"
_C.DATASET.SIZE = 256
